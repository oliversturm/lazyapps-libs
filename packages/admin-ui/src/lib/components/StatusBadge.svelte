<script>
  ...
  const colors = {
    ...
    replay: 'bg-yellow-100 text-yellow-800',
    replaying: 'bg-yellow-100 text-yellow-800',
    'replay-done': 'bg-blue-100 text-blue-800',
    catchup: 'bg-yellow-100 text-yellow-800',
    'catching-up': 'bg-yellow-100 text-yellow-800',
