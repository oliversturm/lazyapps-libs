        ...
        insertEvents(
          ...
          .then(() =>
            waitForCondition(
              ...
              15000,
              100,
              'RM → live after restore+activate',
            ),
          )
          .then(() =>
            waitForCondition(
        ...
        insertEvents(
          ...
          .then((res) => {
            ...
            return waitForCondition(
              ...
              30000,
              100,
              'RM → live after backup replay (10.8)',
            );
          })
          .then(() =>
